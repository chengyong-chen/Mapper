...
class IMapdcom;
class CProjection;
// CMapeasyCtrl : �й�ʵ�ֵ���Ϣ������� MapeasyCtrl.cpp��

class CMapeasyCtrl : public COleControl
{
	DECLARE_DYNCREATE(CMapeasyCtrl)
...
// ʵ��
protected:
	virtual ~CMapeasyCtrl();

	DECLARE_OLECREATE_EX(CMapeasyCtrl)    // �๤���� guid
	DECLARE_OLETYPELIB(CMapeasyCtrl)      // GetTypeInfo
	DECLARE_PROPPAGEIDS(CMapeasyCtrl)     // ����ҳ ID
	DECLARE_OLECTLTYPE(CMapeasyCtrl)		// �������ƺ�����״̬

// ��Ϣӳ��
//{{AFX_MSG(CMapeasyCtrl)
	...
	afx_msg LONG OnCalLength(UINT WPARAM, LONG LPARAM);
	afx_msg LONG OnCalArea(UINT WPARAM, LONG LPARAM);
	DECLARE_MESSAGE_MAP()

// ����ӳ��
protected:
	//{{AFX_DISPATCH(CMapeasyCtrl)
	VARIANT_BOOL OpenAtlas(BSTR bstrAtlas);
