========================================================================
    STATIC LIBRARY : Basal Project Overview
========================================================================

AppWizard has created this Basal library project for you.

This file contains a summary of what you will find in each of the files that
make up your Basal application.
...
StdAfx.h, StdAfx.cpp
    ...
    named Basal.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "Basal.rc" and a "Basal.h" that
