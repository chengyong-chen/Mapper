...
*Copyright (c) 1991-1997 Silicon Gdiplus::Graphics, Inc.
 *
*Permission to use, copy, modify, distribute, and sell this software and 
*its documentation for any purpose is hereby granted without fee, provided
*that (i) the above copyright notices and this permission notice appear in
*all copies of the software and related documentation, and (ii) the names of
*Sam Leffler and Silicon Gdiplus::Graphics may not be used in any advertising or
*publicity relating to the software without the specific, prior written
*permission of Sam Leffler and Silicon Gdiplus::Graphics.
*
...
/* compression code 32947 is reserved for Oceana Gdiplus::Matrix <dev@oceana.com> */
...
/* tags 32952-32956 are private tags registered to Island Gdiplus::Graphics */
...
/* 65550-65556 are allocated to Oceana Gdiplus::Matrix <dev@oceana.com> */
...
/* 65559 is allocated to Oceana Gdiplus::Matrix <dev@oceana.com> */
