...
_TIFFVSetField(TIFF* tif, ttag_t tag, va_list ap)
{
	...
	case TIFFTAG_DATATYPE:
		...
		switch(v)
		{
		case DATATYPE_VOID: v = SAMPLEFORMAT_VOID;
			break;
		case DATATYPE_INT: v = SAMPLEFORMAT_INT;
			break;
		case DATATYPE_UINT: v = SAMPLEFORMAT_UINT;
			break;
		case DATATYPE_IEEEFP: v = SAMPLEFORMAT_IEEEFP;
			break;
...
{
	const TIFFExtendProc prev = _TIFFextender;
