...
{
	long result;
	InvokeHelper(0x60020000, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, nullptr);
	return result;
}

void CFields::Refresh()
{
	InvokeHelper(0x60020002, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
}
...
void CFields::Append(LPCTSTR Name, long Type, long DefinedSize, long Attrib)
{
	...
	InvokeHelper(0x60040000, DISPATCH_METHOD, VT_EMPTY, nullptr, parms,
...
void CFields::Delete(const VARIANT& Index)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x60040001, DISPATCH_METHOD, VT_EMPTY, nullptr, parms,
		&Index);
}
