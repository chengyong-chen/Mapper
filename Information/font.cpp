...
CString COleFont::GetName() const
{
	CString result;
...
BOOL COleFont::GetUnderline() const
{
	BOOL result;
...
BOOL COleFont::GetStrikethrough() const
{
	BOOL result;
...
short COleFont::GetWeight() const
{
	short result;
...
short COleFont::GetCharset() const
{
	short result;
