...
void CRdc::SetRefResultset(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
	InvokeHelper(0xd, DISPATCH_PROPERTYPUTREF, VT_EMPTY, nullptr, parms,
		newValue);
}
...
{
	CString result;
	InvokeHelper(0x10, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, nullptr);
	return result;
}
...
void CRdc::SetRefConnection(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
	InvokeHelper(0x13, DISPATCH_PROPERTYPUTREF, VT_EMPTY, nullptr, parms,
		newValue);
}
...
void CRdc::SetRefEnvironment(LPDISPATCH newValue)
{
	static BYTE parms[] =
		VTS_DISPATCH;
	InvokeHelper(0x1b, DISPATCH_PROPERTYPUTREF, VT_EMPTY, nullptr, parms,
		newValue);
}
...
void CRdc::SetCaption(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(DISPID_CAPTION, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms,
		lpszNewValue);
}
...
{
	short result;
	InvokeHelper(0x20, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, nullptr);
	return result;
}
...
{
	short result;
	InvokeHelper(0x21, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, nullptr);
	return result;
}
...
void CRdc::Cancel()
{
	InvokeHelper(0x28, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
}
