...
__declspec(dllexport) CEllipseTool ellipseTool;
...
void CEllipseTool::OnLButtonUp(CWnd* pWnd, const CViewinfo& viewinfo, UINT nFlags, const CPoint& cliPoint, const CPoint& docPoint)
{
	if(pWnd->GetCapture()==pWnd&&docPoint!=CTool::c_docDown)
	{
		...
		CEllipse* pGeom = new CEllipse(rect, nullptr, nullptr);
...
void CEllipseTool::DrawTrack(CWnd* pWnd, const CViewinfo& viewinfo, CPoint point1, CPoint point2, bool bSquare, bool bCentral)
{
	CClientDC dc(pWnd);
